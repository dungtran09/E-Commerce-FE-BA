...
const Chat = () => {
  ...
  return (
    <div className="end-0 divide-y nav-item absolute right-5 md:right-52 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96 divide-gray-100 border border-gray-100 shadow-lg">
